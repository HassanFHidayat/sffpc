...
<div class="row justify-content-center">
    <div class="col-md-4">
        <main class="form-login w-100 m-auto">
            ...
            @endif
            <h1 class="h3 mb-3 fw-normal text-center">Login untuk Penjual</h1>
            <form action="/login/penjual" method="post">
                @csrf
            ...
            <small class="mt-3 d-block text-center">
                Belum punya akun? <a href="/register/penjual">Silahkan daftar!</a>
            </small>
        </main>
    </div>
</div>
